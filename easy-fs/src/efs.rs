...
pub struct EasyFileSystem {
    pub block_device: Arc<dyn BlockDevice>, // 读取驱动
    pub inode_bitmap: Bitmap,   // 节点map
    pub data_bitmap: Bitmap,    // 数据map
    inode_area_start_block: u32,   // 节点块开始位置
    data_area_start_block: u32,    // 数据块开始位置
}
